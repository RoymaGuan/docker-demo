...
# (2)关闭selinux
setenforce 0 此处为临时关闭
如果要永久关闭，必须更改/etc/selinux/config,将状态改为disabled
...
docker login --username=xxx registry.cn-hangzhou.aliyuncs.com
 ...
 registry.cn-hangzhou.aliyuncs.com/seanguan这是我自己的阿里云镜像地址
```
...
```
# 本地有镜像
kubeadm init --kubernetes-version=1.14.0 --apiserver-advertise-address=192.168.0.104 --pod-network-cidr=10.244.0.0/16
 --apiserver-advertise-address 后面跟MasterIP地址
...
```
kubeadm join 192.168.0.104:6443 --token rhgcol.lhu8txl565mpkhl9 \
    --discovery-token-ca-cert-hash sha256:0be6af94f91526663e630fe5cce13e9909b0a3d9c51598a991fc07b6e381b7dc 
```
